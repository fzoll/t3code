...
export const makeJcodeTextGeneration = Effect.fn("makeJcodeTextGeneration")(function* (
  ...
  const runJcodeJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      const resolvedModel = resolveJcodeAcpBaseModelId(modelSelection.model);
      ...
      const promptResult = yield* Effect.gen(function* () {
        ...
        yield* applyJcodeAcpModelSelection({
          runtime,
          ...
          mapError: (cause) =>
            new TextGenerationError({
              operation,
              detail: "Failed to set jcode ACP base model for text generation.",
              cause,
            }),
        });
        ...
        Effect.flatMap(
          Option.match({
            onNone: () =>
              Effect.fail(
                new TextGenerationError({ operation, detail: "Jcode ACP request timed out." }),
              ),
