...
import Migration0052 from "./Migrations/041_ProjectEnvironment.ts";
import Migration0053 from "./Migrations/042_ProjectIsAuto.ts";
...
const migrationEntries = [
  ...
  [52, "ProjectEnvironment", Migration0052],
