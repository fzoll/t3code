...
import Migration0033 from "./Migrations/033_ProjectEnvironment.ts";
import Migration0034 from "./Migrations/034_ProjectIsAuto.ts";
import Migration0035 from "./Migrations/035_ProjectGroup.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectEnvironment", Migration0033],
  [34, "ProjectIsAuto", Migration0034],
  [35, "ProjectGroup", Migration0035],
] as const;
