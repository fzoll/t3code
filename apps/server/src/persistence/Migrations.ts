...
import Migration0041 from "./Migrations/041_ProjectEnvironment.ts";
import Migration0042 from "./Migrations/042_ProjectIsAuto.ts";
import Migration0043 from "./Migrations/043_ProjectGroup.ts";
import Migration0044 from "./Migrations/044_ReconcileRenumberedForkMigrations.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectEnvironment", Migration0041],
  [42, "ProjectIsAuto", Migration0042],
  [43, "ProjectGroup", Migration0043],
  [44, "ReconcileRenumberedForkMigrations", Migration0044],
] as const;
